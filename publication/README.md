...
<button style="background-color:#e5e5e5; border-color:#e5e5e5">[PDF](https://www.researchgate.net/profile/Ziran-Wang-6/publication/358970927_Mobility_Digital_Twin_Concept_Architecture_Case_Study_and_Future_Challenges/links/6223c63384ce8e5b4d088be4/Mobility-Digital-Twin-Concept-Architecture-Case-Study-and-Future-Challenges.pdf)</button>
...
<button style="background-color:#e5e5e5; border-color:#e5e5e5">[PDF](https://arxiv.org/pdf/2011.13075.pdf)</button>
...
<button style="background-color:#e5e5e5; border-color:#e5e5e5">[PDF](https://arxiv.org/pdf/2009.12509.pdf)</button>
...
<button style="background-color:#e5e5e5; border-color:#e5e5e5">[PDF](https://arxiv.org/pdf/2201.07973.pdf)</button>
...
<button style="background-color:#e5e5e5; border-color:#e5e5e5">[PDF](/paper/MetroCAD22.pdf)</button>
...
<button style="background-color:#e5e5e5; border-color:#e5e5e5">[PDF](/paper/SEC22.pdf)</button>
...
<button style="background-color:#e5e5e5; border-color:#e5e5e5">[PDF](https://par.nsf.gov/servlets/purl/10205860)</button>
...
<button style="background-color:#e5e5e5; border-color:#e5e5e5">[PDF](https://www.researchgate.net/profile/Haoxin-Wang-4/publication/334488707_E-Auto_A_Communication_Scheme_for_Connected_Vehicles_with_Edge-Assisted_Autonomous_Driving/links/5f8755e2a6fdccfd7b62572e/E-Auto-A-Communication-Scheme-for-Connected-Vehicles-with-Edge-Assisted-Autonomous-Driving.pdf)</button>
...
<button style="background-color:#e5e5e5; border-color:#e5e5e5">[PDF](https://par.nsf.gov/servlets/purl/10199522)</button>
...
<button style="background-color:#e5e5e5; border-color:#e5e5e5">[PDF](/paper/SECON18.pdf)</button>
...
<button style="background-color:#e5e5e5; border-color:#e5e5e5">[PDF](https://par.nsf.gov/servlets/purl/10077029)</button>
...
<button style="background-color:#e5e5e5; border-color:#e5e5e5">[PDF](/paper/ICC17.pdf)</button>
